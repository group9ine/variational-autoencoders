def scan(filename, x,y,z):
    ...
    res=[[[[0 for i in range(x*10)]for j in range(y*10)]for k in range(z*10)]for h in range(len(data))]
...
if __name__=="__main__":
    ...
    grid=[[[(i/10, j/10,k/10) if res[0][i][j][k] else (None, None, None) for i in range(10)] for j in range(10)] for k in range(10)]
